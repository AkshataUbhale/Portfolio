...
import './ProfileCard.css'; // Make sure you have created and populated this CSS file
...
const ProfileCardComponent = ({
  avatarUrl = 'src/public/profilephoto.jpeg',
  iconUrl = 'src/public/icon.png',
